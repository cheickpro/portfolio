  ...
  return (
    <section className="relative overflow-hidden py-24">
      <div className="mx-auto max-w-7xl px-6 text-center">
        ...
        >
          A selection of research and software engineering projects focused on
          Artificial Intelligence, Deep Learning, Computer Vision, and Network
          Security. These projects reflect both academic research and practical
